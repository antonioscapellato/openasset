  ...
  return (
    <footer id="footer" className="relative z-50 dark:bg-gray-900 pt-24">
                                ...
                                <div className="w-full lg:w-1/2 px-6">
                                    <ul>
                                        <li>
                                                ...
                                                <a className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-50 dark:text-gray-50">Components</a>
                                            
                                        </li>
                                        
                                        <li className="mt-6">
                                            <a href="javascript:void(0)" className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-50 dark:text-gray-50">
                                                Documentation
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div className="w-full lg:w-1/2 px-6">
                                    <ul>
                                        <li>
                                                ...
                                                <a className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-50 dark:text-gray-50">Free components</a>
                                ...
                                <div className="w-full lg:w-1/2 px-6">
                                    <ul>
                                        ...
                                        <li className="mt-6">
                                                ...
                                                <a className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-50 dark:text-gray-50">Terms of service</a>
                ...
                <div className="py-16 flex flex-col justify-center items-center">                  
                    <p className="mt-6 text-xs lg:text-sm leading-none text-gray-900 dark:text-gray-50">Made By Antonio Scapellato</p>
                </div>
            </footer>
  )
}
